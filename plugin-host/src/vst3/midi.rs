...
impl ParameterChanges {
    ...
    pub fn add_point(&self, param_id: ParamID, sample_offset: i32, value: f64) {
    ...
    #[allow(clippy::mut_from_ref)]
    pub fn queues_mut(&self) -> &mut Vec<ComWrapper<ParameterValueQueue>> {
        unsafe { &mut *self.queues.get() }
    }

    pub fn queues_ref(&self) -> &Vec<ComWrapper<ParameterValueQueue>> {
...
impl ParameterValueQueue {
    ...
    pub fn parameter_id(&self) -> ParamID {
        self.param_id
    }

    pub fn push_point(&self, sample_offset: i32, value: f64) {
        self.points_mut()
            .push((sample_offset, value.clamp(0.0, 1.0)));
    }

    #[allow(clippy::mut_from_ref)]
    pub fn points_mut(&self) -> &mut Vec<(i32, f64)> {
        unsafe { &mut *self.points.get() }
    }

    pub fn points_ref(&self) -> &Vec<(i32, f64)> {
