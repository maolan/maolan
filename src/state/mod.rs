...
pub use track::{AuxSend, Track, TrackAutomationLane, TrackAutomationPoint};
...
pub struct StateData {
    ...
    pub comp_swipe_start: Option<Point>,
    pub comp_swipe_end: Option<Point>,
